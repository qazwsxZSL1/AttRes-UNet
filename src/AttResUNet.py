...
#         if channel_wise:
#             self.dim_head = 1
#         self.att = attbase(input_dim=input_dim, dim_head=self.dim_head)
#     def forward(self, xt):
#         attfeature = self.att(xt)
#         return attfeature
#
...
#         self.newAtt1 = newAtt(input_dim=base_c, channel_wise=channel_wise_mrla)
#         self.bn_att1 = norm_layer(base_c)
#         self.down1 = Down(base_c, base_c * 2)
#         self.newAtt2 = newAtt(input_dim=base_c *2, channel_wise=channel_wise_mrla)
#         self.bn_att2 = norm_layer(base_c *2)
#         self.down2 = Down(base_c * 2, base_c * 4)
#         self.newAtt3 = newAtt(input_dim=base_c *4, channel_wise=channel_wise_mrla)
#         self.bn_att3 = norm_layer(base_c * 4)
#         self.down3 = Down(base_c * 4, base_c * 8)
#         self.newAtt4 = newAtt(input_dim=base_c *8, channel_wise=channel_wise_mrla)
#         self.bn_att4 = norm_layer(base_c * 8)
#
...
#         x1 = self.in_conv(x)
#         atten1 = self.newAtt1(x1)
#         atten1 = self.bn_att1(atten1)
#         atten1 = self.relu(atten1)
#         x1 = x1 + self.drop_path(atten1)
#         x2 = self.down1(x1)
#         atten2 = self.newAtt2(x2)
#         atten2 = self.bn_att2(atten2)
#         atten2 = self.relu(atten2)
#         x2 = x2 + self.drop_path(atten2)
#         x3 = self.down2(x2)
#         atten3 = self.newAtt3(x3)
#         atten3 = self.bn_att3(atten3)
#         atten3 = self.relu(atten3)
#         x3 = x3 + self.drop_path(atten3)
#         x4 = self.down3(x3)
#         atten4 = self.newAtt4(x4)
#         atten4 = self.bn_att4(atten4)
